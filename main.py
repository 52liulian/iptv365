...
about_video1="https://gitee.com/liulian8/tv/raw/master/dfd5645687mjm.mp4"
...
all_lines =  ["⏰更新时间,#genre#"] + [version] + [daily_mtv] + ['\n'] +\
             ...
             ["📺电视剧,#genre#"] + sort_data(dsj_dictionary,correct_name_data(corrections_name,dsj_lines)) + ['\n'] + \
             ["🎬明星电影,#genre#"] + sort_data(mx_dictionary,correct_name_data(corrections_name,mx_lines)) + ['\n'] + \
             ["🎬主题片,#genre#"] + sort_data(ztp_dictionary,correct_name_data(corrections_name,ztp_lines)) + ['\n'] + \
             ["🌊港·澳·台,#genre#"] + sort_data(gat_dictionary,correct_name_data(corrections_name,gat_lines)) + ['\n'] + \
             ...
             ["🖌️动画片,#genre#"] + sort_data(dhp_dictionary,set(correct_name_data(corrections_name,dhp_lines)))+ ['\n'] + \
...
def make_m3u(txt_file, m3u_file):
    try:
        output_text = f'#EXTM3U x-tvg-url="https://live.fanmingming.cn/e.xml"\n'
